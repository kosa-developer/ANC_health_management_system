...
<script> var logoutLink = '<?php echo $crypt->encode("logout") ?>';</script>
    ...
    function readURL1(input) {
        ...
        img.onload = function () {
            ...
            if (imgwidth <= maxwidth && imgheight <= maxheight) {
                ...
                alert('The image width and height must be less than to 1000 and 1000 cm respectively \nPlease reformat your image and try again');
    ...
    function readURL(input, id) {
        ...
        img.onload = function () {
            ...
            if (imgwidth <= maxwidth && imgheight <= maxheight) {
                ...
                alert('The image width and height must be less or equal to 1000 and 1000 respectively \nPlease reformat your image and try again');
